...
namespace $rootnamespace$
{
    ...
    public class $safeitemname$ : Exception
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="$safeitemname$"/> class with a specified
        /// error message.
        /// </summary>
        ...
        /// <exception cref="ArgumentNullException">The <em>info</em> parameter is
        /// <strong>null</strong>.</exception>
        /// <exception cref="SerializationException">The class name is <strong>null</strong> or
        /// <see cref="HResult"/> is zero (0).</exception>
